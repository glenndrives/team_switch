...
print("VCL Port 01 Main = " + vclPort01Main.decode('utf-8'))
print("VCL Port 01 Standby = " + vclPort01Standby.decode('utf-8'))
print("VCL Port 01 Equipment = " + vclPort01Eqpmt.decode('utf-8'))

print("Team N05 Loss of Sync = " + teamN05.decode('utf-8'))
print("Team N06 Loss of Signal = " + teamN06.decode('utf-8'))
print("\nRelay Board Status\n")
print("GPIO Status = " + str(mcp23008.get_all_gpio_status()))

msg = "\nVCL and TEAM Alarms\n\n"
msg += "VCL Port 01 Main = " + vclPort01Main.decode('utf-8') + "\n"
msg += "VCL Port 01 Standby = " + vclPort01Standby.decode('utf-8') + "\n"
msg += "VCL Port 01 Equipment = " + vclPort01Eqpmt.decode('utf-8') + "\n"
msg += "Team N05 Loss of Sync = " + teamN05.decode('utf-8') + "\n"
msg += "Team N06 Loss of Signal = " + teamN06.decode('utf-8') + "\n\n"
